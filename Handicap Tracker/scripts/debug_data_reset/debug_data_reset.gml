...
var date = date_create_datetime(2023,8,19,1,1,1); scr_score_add_index("Estrella Del Mar","FL","white","78",date);
var date = date_create_datetime(2023,8,21,1,1,1); scr_score_add_index("Estrella Del Mar","FL","white","77",date,1);
var date = date_create_datetime(2023,8,22,1,1,1); scr_score_add_index("Estrella Del Mar","FL","gold","82",date,1);
var date = date_create_datetime(2023,8,24,1,1,1); scr_score_add_index("Estrella Del Mar","FL","white","86",date);
