...
scr_course_create("Newton Commonwealth","MA",arr);
...
scr_course_create("Pembroke Country Club","MA",arr);
scr_course_add_tee(course_struct,"blue","6677","132","73.3","71");

scr_course_create("Pinehills - Nicklaus","MA",arr);
scr_course_add_tee(course_struct,"blue","6640","131","72.2","72");

scr_course_create("Putterham Meadows","MA",arr);
