...
switch textboxIndex
	...
	case course_data.yardage: active_course.courseYardage = string_convert_real(keyboard_string,4); break;
							  
	case course_data.slope: active_course.courseSlope = string_convert_real(keyboard_string,3); break;
							  
	case course_data.rating: active_course.courseRating = string_convert_rating(keyboard_string,3); break;
							  
	case course_data.par: active_course.coursePar = string_convert_real(keyboard_string,2); break;
	}
#endregion
