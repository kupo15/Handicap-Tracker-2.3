...
function ds_list_sort_nested_struct_if(source_list,key,ifKey,ifCondition,ascending) {
/// @description sorts nested lists within structs
/// @param source_list
/// @param sort_key
/// @param if_key
...
function array_sort_nested_struct_if(source_array,key,ifKey,ifCondition,ascending) {
/// @description sorts nested structs within arrays
/// @param source_array
/// @param sort_key
/// @param if_key
