...
function funct_screen_scrolling_hor_old(xx,yy,ww,hh,sep,list_size,list_disp,offset_start_pointer,offset_pointer,scrollbar_index,sub) {
...
if scrollbar_index == scrollbarIndexScrolling
	...
	var flick_amt = (mouse_x-mouse_xprev);
	...
	if mouse_x != mouse_xprev // if the mouse moved since the last step
		{
		canFlick = true;
